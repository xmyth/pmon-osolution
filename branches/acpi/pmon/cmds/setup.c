...
#define BLK "\e[30m" /* ºÚÉ« */
#define RED "\e[31m" /* ºìÉ« */
#define GRN "\e[32m" /* ÂÌÉ« */
#define YEL "\e[33m" /* »ÆÉ« */
#define BLU "\e[34m" /* À¶É« */
#define MAG "\e[35m" /* ×ÏÉ« */
#define CYN "\e[36m" /* ÇàÉ« */
#define WHT "\e[37m" /* °×É« */


/* ±³¾°É« */

#define BBLK "\e[40m" /*ºÚÉ« */
#define BRED "\e[41m" /*ºìÉ« */
#define BGRN "\e[42m" /*ÂÌÉ« */
#define BYEL "\e[43m" /* »ÆÉ« */
#define BBLU "\e[44m" /*À¶É« */
#define BMAG "\e[45m" /*×ÏÉ« */
#define BCYN "\e[46m" /*ÇàÉ« */
#define BWHT "\e[47m" /* °×É« */


/* ÐÂÔöµÄAnsiÑÕÉ«¶¨Òå×Ö·û¡£ÓÉ Gothic april 23,1993 */
/* ×¢Òâ£ºÕâÐ©²Ù×÷·ûÊÇÎªVT100ÖÕ¶ËÉè¼ÆµÄ¡£ */

#define NOR "\e[0m" /* ·µ»ØÔ­É« */
#define BOLD "\e[1m" /* ¼ÓÁÁ»ò´ò¿ª´ÖÌå */
#define U "\e[4m" /* ÏÂ»®ÏßÄ£Ê½ */
#define BLINK "\e[5m" /* ²»¶ÏÉÁÁÁÄ£Ê½ */
#define REV "\e[7m" /* ´ò¿ª·´°×Ä£Ê½ */
#define CLR "\e[2J" /* ÇåÆÁ */
#define HOME "\e[H" /* ·¢ËÍ¹â±êµ½Ô­´¦ */
#define REF CLR+HOME /* ÇåÆÁºÍÇå³ý¹â±ê */
...
#define FRTOP "\e[2;25r" /*ÉèÖÃ2-25ÐÐ¹ö¶¯,ÆäËûÐÐ¶³½á*/
#define UNFR "\e[r" /*»Ö¸´È«²¿¹ö¶¯*/
/*
×¢Òâ "\e[0m\e[37;44m"µÄµÈ¼ÛÓÚ" "\e[0;37;44m"
ÒÔÉÏµÄº¬Òå¿ÉÒÔ×éºÏ
*/
#endif
//---------------------------------------------------------------------------
